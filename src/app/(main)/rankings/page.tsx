    ...
    <div className="w-full">
      ...
      <div className="flex justify-center mb-6">
        <div className="flex items-center bg-gray-100 rounded-full p-1">
          <span className={`px-4 py-2 rounded-full text-sm font-medium cursor-pointer transition-colors duration-200 ${viewMode === 'card' ? 'bg-white text-blue-600 shadow' : 'text-gray-600'}`} onClick={() => setViewMode('card')}>
            카드
          </span>
          <span className={`px-4 py-2 rounded-full text-sm font-medium cursor-pointer transition-colors duration-200 ${viewMode === 'table' ? 'bg-white text-blue-600 shadow' : 'text-gray-600'}`} onClick={() => setViewMode('table')}>
            표
          </span>
        </div>
      </div>
